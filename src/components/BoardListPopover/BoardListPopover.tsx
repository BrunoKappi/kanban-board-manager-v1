  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <div className="md:hidden md:max-w-72 w-full md:min-w-96 truncate flex flex-row justify-between items-center gap-2 bg-slate-400/10 dark:bg-slate-400/5 rounded-full px-5 py-2 ">
